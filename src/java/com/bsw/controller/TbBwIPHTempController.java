 ...
 */
public class TbBwIPHTempController {
    
    
    public static TbBwIPHTempController getInstance(){
        return new TbBwIPHTempController();
    }
    ...
    public ResponseInterface saveIPH(
      ...
      String tglPerjanjian, String noKeputusan, String tglKeputusan,String tglPL, String tglCert){
        ...
        try {
            ...
            Logger.getLogger(TbBwIPHTempController.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        return DaoManager.getTbBWIPHTempDao().saveIPH(tbBwIPH);
    ...
    public List<MonitoringIPH> monitoringIPH(String idIPH, String plNo, String applyStat,
        ...
        try {
            return DaoManager.getTbBWIPHTempDao().getMonitoring(idIPH, plNo, applyStat, fromDate, toDate, applyTp, statVer, creator);
    ...
    public List<MonitoringIPH> monitoringIPH(String idIPH, String plNo, String applyStat,
        ...
        try {
            return DaoManager.getTbBWIPHTempDao().getMonitoringSort(idIPH, plNo, applyStat, fromDate, toDate, applyTp, statVer, creator, tipe, ascDesc);
        } catch (SQLException ex) {
            System.out.println("EXC "+ex);
           return new ArrayList<MonitoringIPH>();
        }
    ...
    public List<MonitoringIPH> monitoringIPH(String creator){
        try {
            return DaoManager.getTbBWIPHTempDao().getMonitoring(creator);
        } catch (SQLException ex) {
            System.out.println("EXC "+ex);
           return new ArrayList<MonitoringIPH>();
        }
    ...
    public List<MonitoringIPH> monitoringIPHSort(String creator, int tipe, String content, String ascDesc){
        try {
            return DaoManager.getTbBWIPHTempDao().getMonitoringSort(creator, tipe,  ascDesc);
        } catch (SQLException ex) {
            System.out.println("EXC "+ex);
           return new ArrayList<MonitoringIPH>();
        }
    ...
    public TbBWIPH getIPH(String iph){
        try {
            return DaoManager.getTbBWIPHTempDao().getIPH(iph);
        } catch (SQLException ex) {
    ...
    public ResponseInterface updateIPH(
      ...
      String tglPerjanjian, String noKeputusan, String tglKeputusan, String tglPL, String tglCert){
        ...
        return DaoManager.getTbBWIPHTempDao().updateIPH(tbBwIPH);
        
        
   }
    
   public ResponseInterface updateIPH(String date, String idIPH){
        return DaoManager.getTbBWIPHTempDao().updateVerIPH(date,idIPH);
        
   }
   
   public ResponseInterface updateDocStatIPH(String docStat, String idIPH){
        return DaoManager.getTbBWIPHTempDao().updateDocStatIPH(docStat,idIPH);
        
   }
   
    public List getAvailableDate(String token, String applyTp){
        return DaoManager.getTbBWIPHTempDao().getAvailableDate(applyTp);
